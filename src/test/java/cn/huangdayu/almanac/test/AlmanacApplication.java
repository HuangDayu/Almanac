...
//            "月出", "月中", "月落", "港口", "儒略日", "干支年", "干支月", "干支日", "干支时", "黄帝纪元", "生肖", "农历年", "农历月", "农历日", "月天数", "大月否",
...
//        //TimeBean timeBean = new TimeBean(strs);
//
//        TimeZoneDTO timeZoneDTO = new TimeZoneDTO("北京市北京市", Calendar.getInstance());
//
...
//        });
//
////        for (AlmanacDTO almanacDTO : AlmanacUtils.monthlyCalendar(timeZoneDTO)) {
////            pakMap(almanacDTO).forEach((K, V) -> {
////                System.out.println(K + ":" + V);
////            });
////        }
//
//    }
//
//    public static Map<String, Object> pakMap(AlmanacDTO almanacData) {
...
//        map.put("黄帝纪元", almanacData.getChronology());
...
//        map.put("月出", almanacData.getMoonRiseTime());
//        map.put("月中", almanacData.getMoonMiddleTime());
//        map.put("月落", almanacData.getMoonSetTime());
