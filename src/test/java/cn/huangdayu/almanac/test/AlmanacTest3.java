...
//        map.put("当下节气", " | " + almanacDTO1.getCurrentSolarTerm() + " | " + almanacDTO2.getCurrentSolarTerm() + " | " + almanacDTO3.getCurrentSolarTerm());
//        map.put("最近节气", " | " + almanacDTO1.getNextSolarTerm() + " | " + almanacDTO2.getNextSolarTerm() + " | " + almanacDTO3.getNextSolarTerm());
