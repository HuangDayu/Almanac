...
//                AlmanacUtils.dayCalendar(new TimeZoneDTO("广东省","徐闻县", "2021-02-02 11:14:48")),
...
//                AlmanacUtils.dayCalendar(new TimeZoneDTO("广东省", "徐闻县", Calendar.getInstance())),
                ...
                AlmanacUtils.dayCalendar(new TimeZoneDTO("广东省", "徐闻县", 2021,4,20,3,59,48)),

//                AlmanacUtils.dayCalendar(new TimeZoneDTO("广东省", "徐闻县", -210,2,12,3,59,48)),


//                AlmanacUtils.dayCalendar(new TimeZoneDTO("广东省","徐闻县", Calendar.getInstance())),
//                AlmanacUtils.dayCalendar(new TimeZoneDTO("广东省","徐闻县", "2018-11-01 11:06:48")),
//                AlmanacUtils.dayCalendar(new TimeZoneDTO("广东省","徐闻县", "1995-08-12 11:10:10")),
//                AlmanacUtils.dayCalendar(new TimeZoneDTO("广东省","徐闻县", "1-1-1 11:10:10"))
        };
